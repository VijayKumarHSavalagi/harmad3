...
# Generated on: Fri Feb 28 11:04:43 IST 2025 (Fri Feb 28 05:34:43 UTC 2025)
...
set logfile fv/alu_32bit_case/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/alu_32bit_case -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  alu_32bit.v
elaborate_design -golden -root {alu_32bit_case} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/alu_32bit_case/fv_map.v.gz
elaborate_design -revised -root {alu_32bit_case}
...
set_system_mode lec
write_compared_points noneq.compared_points.alu_32bit_case.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.alu_32bit_case.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.alu_32bit_case.rtl.fv_map.rpt
